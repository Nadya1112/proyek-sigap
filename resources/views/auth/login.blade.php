  ...
  <div class="w-full max-w-[460px] bg-white rounded-[26px] shadow-xl border border-gray-100">
    <div class="px-8 pt-9 pb-9">
      ...
      <div x-data="{ show: true }" 
           ...
           class="mt-4 p-4 rounded-2xl bg-green-50 border border-green-200 relative">
        <div class="flex items-start gap-3">
          ...
          {{-- Tombol Close --}}
          <button @click="show = false" class="flex-shrink-0 text-green-400 hover:text-green-600 transition">
