    ...
    <div x-data="{ tab: '{{ $token ? 'keamanan' : 'informasi' }}' }" class="mt-10 max-w-4xl mx-auto">
        ...
        <div class="border-b border-gray-200">
            <nav class="-mb-px flex space-x-6">
                ...
                <a href="#" @click.prevent="tab = 'bahaya'" :class="{ 'border-red-500 text-red-600': tab === 'bahaya', 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300': tab !== 'bahaya' }" class="whitespace-nowrap py-4 px-1 border-b-2 font-semibold text-sm transition-colors">Zona Berbahaya</a>
            </nav>
        </div>
